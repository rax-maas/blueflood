...
package com.rackspacecloud.blueflood.core.service;

import com.rackspacecloud.blueflood.service.Configuration;
import com.rackspacecloud.blueflood.service.CoreConfig;
import com.rackspacecloud.blueflood.service.ScheduleContext;
import com.rackspacecloud.blueflood.service.ShardStateManager;
import com.rackspacecloud.blueflood.service.ZKShardLockManager;
...
public class ScheduleContextIntegrationTest {
    ...
    public void setUp() {
        ...
        manageShards.add(7);
        manageShards.add(11);
        context = new ScheduleContext(1234, manageShards, Configuration.getInstance().getStringProperty(
            CoreConfig.ZOOKEEPER_CLUSTER));
    ...
    public void testSetShardAddition() throws Exception {
        ...
        context.addShard(2);
        Assert.assertArrayEquals(manageShards.toArray(), shardStateManager.getManagedShards().toArray());
        final ZKShardLockManager lockManager = (ZKShardLockManager) Whitebox.getInternalState(context,
                "lockManager");
