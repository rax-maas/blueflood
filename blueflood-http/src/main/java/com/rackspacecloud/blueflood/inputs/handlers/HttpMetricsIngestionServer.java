...
public class HttpMetricsIngestionServer {
    ...
    private static int WRITE_THREADS = Configuration.getInstance().getIntegerProperty(CoreConfig.BATCH_WRITER_THREADS); // metrics will be batched into this many partitions.
