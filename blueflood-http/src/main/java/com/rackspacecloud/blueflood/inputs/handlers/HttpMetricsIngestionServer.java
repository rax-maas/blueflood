...
public class HttpMetricsIngestionServer {
    ...
    public HttpMetricsIngestionServer(ScheduleContext context, IMetricsWriter writer) {
        ...
        router.post("/v2.0/:tenantId/events", new HttpEventsIngestionHandler((GenericElasticSearchIO)GenericClassLoader.getGenericInstance(GenericElasticSearchIO.class, CoreConfig.EVENTS_MODULES)));
