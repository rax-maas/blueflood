...
import com.rackspacecloud.blueflood.io.astyanax.AstyanaxTestIO;
import com.rackspacecloud.blueflood.io.datastax.DatastaxMetadataIO;
import com.rackspacecloud.blueflood.io.datastax.DatastaxTestIO;
...
public class MetadataCacheIntegrationTest extends IntegrationTestBase {
    ...
    public MetadataCacheIntegrationTest(MetadataIO mIO, TestIO tIO) {
        metadataIO = mIO;
        testIO = tIO;
    }
    ...
    public void testPut() throws Exception {
        Assert.assertEquals( 0, testIO.getKeyCount( CassandraModel.CF_METRICS_METADATA_NAME ) );
        ...
        Assert.assertEquals( 1, testIO.getKeyCount( CassandraModel.CF_METRICS_METADATA_NAME ) );

        cache.put(loc2, "metaA", "hello");
        
        Assert.assertEquals( 2, testIO.getKeyCount( CassandraModel.CF_METRICS_METADATA_NAME ) );
    }
    ...
    public static Collection<Object[]> getIOs() {
        ...
        ios.add(new Object[] { new AstyanaxMetadataIO(), new AstyanaxTestIO() });
        ios.add(new Object[] { new DatastaxMetadataIO(), new DatastaxTestIO() });
