...
public class EnumRollupSerializationTest {
    ...
    public void testEnumV1RoundTrip() throws IOException {
        ...
        while (version <= maxVersion) {
            ...
            Assert.assertTrue(AssertHelper.areEquals(e0, ee0));
            ...
            //Assert.assertFalse(e1.equals(ee1));
            version++;
            count++;
        }
    ...
    private static class AssertHelper {
        public static boolean areEquals(EnumRollup e1, EnumRollup e2) {
            if (e1 != null && e2 != null) {
                if (e1.getHashes().size() == e2.getHashes().size()) {
                    if (e1.getHashes().keySet().equals(e2.getHashes().keySet())) {
                         return e1.getHashes().values().equals(e2.getHashes().values());
                    }
                }
            }
