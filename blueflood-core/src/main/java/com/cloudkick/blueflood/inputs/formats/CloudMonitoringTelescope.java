...
public class CloudMonitoringTelescope extends MetricsContainer {
    ...
    public List<Metric> toMetrics() {
        ...
        final List<com.cloudkick.blueflood.types.Metric> metrics = new ArrayList<Metric>();
        for (Map.Entry<String, telescope.thrift.Metric> telMetric : telMetrics.entrySet()) {
            ...
            final com.cloudkick.blueflood.types.Metric metric = new com.cloudkick.blueflood.types.Metric(locator,
