...
/**
 * Will eventually become SingleRollupReadContext as soon as the existing SingleRollupReadContext is renamed to ScheduleContext.
...
class SingleRollupReadContext {
    ...
    SingleRollupReadContext(Locator locator, Range rangeToRead, ColumnFamily srcColumnFamily, ColumnFamily destColumnFamily) {
