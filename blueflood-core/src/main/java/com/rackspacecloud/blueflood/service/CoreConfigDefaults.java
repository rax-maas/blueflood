 ...
 */
public enum CoreConfigDefaults implements ConfigDefaults {
    ...
    static {
        Configuration.getInstance().loadDefaults(CoreConfigDefaults.values());
    }
    private String defaultValue;
    private CoreConfigDefaults(String value) {
