...
public class AstyanaxIO {
    ...
    public static final MetricColumnFamily CF_METRICS_HIST_20M = new MetricColumnFamily("metrics_histogram_5m", new TimeValue(3, TimeUnit.DAYS));
    public static final MetricColumnFamily CF_METRICS_HIST_60M = new MetricColumnFamily("metrics_histogram_5m", new TimeValue(31, TimeUnit.DAYS));
    public static final MetricColumnFamily CF_METRICS_HIST_240M = new MetricColumnFamily("metrics_histogram_5m", new TimeValue(60, TimeUnit.DAYS));
    public static final MetricColumnFamily CF_METRICS_HIST_1440M = new MetricColumnFamily("metrics_histogram_5m", new TimeValue(365, TimeUnit.DAYS));
    ...
    private static final MetricColumnFamily[] METRIC_COLUMN_FAMILES = new MetricColumnFamily[] {
            ...
            CF_METRICS_PREAGGREGATED_1440M, CF_METRICS_HIST_5M, CF_METRICS_20M, CF_METRICS_60M,
            CF_METRICS_240M, CF_METRICS_1440M,
            CF_METRICS_STRING
    };
