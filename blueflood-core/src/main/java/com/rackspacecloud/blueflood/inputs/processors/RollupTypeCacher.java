...
public class RollupTypeCacher extends FunctionWithThreadPool<MetricsCollection, Void> {
    ...
    private void record(MetricsCollection input) {
        for (IMetric metric : input.toMetrics()) {
            try {
                // TODO: This is an oblique way of saying store rollup type only for PreAggregatedMetrics
                // Once datatype numeric is implemented replace this with metric.getDataType is Numeric or String
